$(document).ready(function () {
  ...
  var freqs = [
    80, 100, 150, 200, 250, 300, 350, 400, 500, 600, 700, 800, 900, 1000, 1200,
    1500, 1800, 2000, 2500, 3000, 3500, 4000, 5000, 6000, 7000, 8000, 10000,
  ];
  var freq = 0;
  var perfectanswers = [];
  var correctanswers = [];
  ...
  window.rePlay = function () {
    // For some reason this made it happier in FF:
