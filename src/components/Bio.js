            ...
            <div className="container mx-auto flex md:px-10 py-20 px-5 md:flex-row flex-col items-center">
                <div
                    ...
                    <div className="text-xl leading-relaxed lg:w-2/3 xl:w-1/2 w-full">
                        ...
                        <p>
                            I'm also a massive NFL geek, I root Dallas but that's sort of secondary to what fascinates me about the
                            sport. I learned R so I could keep track of each time a player gained his jersey number in
