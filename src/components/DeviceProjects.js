      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <p className="lg:w-1/2 mx-auto leading-relaxed text-lg">
            I have a hobby of making devices (sometimes of dubious utility).
            Often with Arduino or Raspberry Pi. Here's a couple recent ones.
          </p>
        </div>
        <div className="flex flex-wrap -m-4 pb-10 ">
          {deviceprojects.map((project) => (
            <div key={project.image} className="w-full xl:w-1/2 h-100 p-8 ">
