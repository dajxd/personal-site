...
export default function WebProjects() {
  return (
    <section id="webprojects" className="resblue body-font">
          ...
          <a
              ...
              <div className="flex relative min-h-full resbluetext metasite">
                ...
                <div className="px-8 py-10 relative z-9 w-full min-h-full border-4 border-gray-800 bg-gray-50 opacity-0 hover:opacity-100">
                  ...
                  <p className="leading-relaxed text-grey-900">A simple one-page personal and portfolio site with images and descriptions of some of my projects. It may look familiar to you.</p>
