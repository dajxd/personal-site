...
export default function WebProjects() {
  return (
    <section
      id="webprojects"
      className="resblue body-font md:border-none border-b-4 border-red-300"
    >
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <a key="" className="w-full md:w-1/2 2xl:w-1/3 h-100 p-8 ">
            ...
            <div
              className="flex relative min-h-full resbluetext bordershape"
              id="metasite"
            >
              <div className="absolute inset-0 w-full h-full min-h-full object-cover object-center imageborder bordershape" />
              <div className="px-8 py-10 relative z-9 w-full min-h-full border-4 notes bordershape bg-gray-50 opacity-0 hover:opacity-100">
                <h2 className="tracking-widest text-sm title-font font-bold text-red-300 mb-5">
                  React, Tailwind CSS
                </h2>
                <p className="leading-relaxed text-grey-900">
                  A simple single page personal and portfolio site. It may look
                  familiar to you! I wanted to make a very responsive site that
                  reflected my personality more than the many very techy-looking
                  portfolio sites. My goal was warmth, flexibility, and a little
                  bit of cute.
                </p>
              </div>
            </div>
