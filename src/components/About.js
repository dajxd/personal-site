        ...
        <section id="about" className="md:border-none border-b-4 border-red-300">
            <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center ">
                <div className="lg:flex-grow  flex flex-col md:text-center mb-16 md:mb-0 items-center text-center">
                    ...
                    <h2 className="text-2xl md:text-lg mb-4 font-medium resbluetext">Below are some of my projects, get
                        in touch if you think I could help you with yours!
                    </h2>
                    <br className="inline-block"/>
                    <div className="flex justify-center mt-10">
                        <a
                            href="#contact"
                            className="inline-flex text-white bg-green-600 border-0 py-2 px-6 hover:bg-green-500 focus:bg-green-500 rounded md:text-xl text-md font-semibold md:font-normal bordershape">
                            Get in touch
                        </a>
                        <a
                            href="#bio"
                            className="ml-4 inline-flex resblueback border-0 py-2 px-6 hover:bg-gray-700 hover:bg-blue-500 focus:bg-blue-500 text-white rounded md:text-xl text-md font-semibold md:font-normal bordershape">
                            Get to know me
                        </a>
                    </div>
                </div>
