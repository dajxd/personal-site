...
export default function Navbar() {
  return (
    <header className="resyellow md:sticky top-0 z-10 md:border-none border-b-4 border-red-300 md:border-none border-b-4 border-red-300">
      <div className="container mx-auto flex flex-wrap md:p-5 p-0 pb-3 flex-col md:flex-row items-center">
        <div className=" flex items-spread justify-between items-baseline px-5 md:items-center w-full md:w-auto">
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 flex flex-wrap md:items-center text-lg md:justify-center md:w-auto items-baseline items-spread justify-between w-full px-10">
          <a
            href="#webprojects"
            className="mr-6 hover:text-red-300 focus:text-red-300"
          >
            Web Projects
          </a>
          <a
