    ...
    return (
        <header
            ...
            <div className=" flex items-spread justify-between items-baseline px-5 md:items-center w-full md:w-auto">
                ...
                <nav
                    className="md:mr-auto md:ml-4 md:py-1 md:pl-4 flex flex-wrap md:items-center text-lg md:justify-center md:w-auto items-baseline items-spread justify-between w-full px-10">
